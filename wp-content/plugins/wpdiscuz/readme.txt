...
2. wpDiscuz comment list with total and separate like/vote mode | Screenshot #2
3. wpDiscuz ajax comment form with social login buttons and Quicktags | Screenshot #3
4. wpDiscuz ajax comment form with Super Socializer plugin | Screenshot #4
5. wpDiscuz comment list and user role label coloring | Screenshot #5
6. Live Update: checks for new comments and shows update buttons | Screenshot #6
7. Comment editing #7
8. wpDiscuz comments on Tab and Smartphones | Screenshot #8
9. wpDiscuz Settings | Screenshot #9
10. wpDiscuz Comment form with "Media Uploader", "Emoticons" and "Comment Search" pro addons | Screenshot #10
