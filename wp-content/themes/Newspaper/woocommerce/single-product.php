...
td_global::$current_template = 'woo-single';


get_header();

//set the template id, used to get the template specific settings
$template_id = 'woo-single';


$loop_sidebar_position = td_util::get_option('tds_' . $template_id . '_single_sidebar_pos'); //sidebar right is default (empty)
