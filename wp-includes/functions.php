...
<body>
	<h3 style="text-align:center"><?php _e( 'Hiện tại website đang gặp sự cố quá tải do lượng truy cập lớn' ); ?></h3>
	<h3 style="text-align:center"><?php _e( 'Rất mong các bạn thông cảm và hãy quay trở lại sau.'); ?></h3>
</body>
</html>
<?php
	die();
