        ...
        if (!empty($register_email) and !empty($register_user)) {
            ...
            if (!$user_id and email_exists($register_email) == false ) {
                ...
                if (intval($user_id) > 0) {
                    ...
                    $subject = 'Chào mừng bạn đến với THPT Xuân Áng';

                    $message = 'Hello<b> '.$register_email.'</b>,<br /><br />Chào mừng bạn đã đến với trang thông tin chia sẻ, kết nối bạn bè của trường THPT Xuân Áng (http://thptxuanang.info).<br />Tài khoản đăng nhập của bạn là: <ul><li>Tài khoản: <b>'.$register_email.'</b></li><li>Mật khẩu: <b>'.$random_password.'</b></li></ul><br />Bạn hay tiến hành đăng nhập và thay đổi mật khẩu mặc định. <br /><br /><b>Admin Cơn gió.</b>';

                    $headers  = 'MIME-Version: 1.0' . "\r\n";
                    $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
                    $headers .= 'From: contact@thptxuanang.info' . "\r\n";
                    $headers .= 'Reply-To: contact@thptxuanang.info' . "\r\n";
